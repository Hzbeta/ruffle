...
gamemode-tooltip =
    O modo de jogo aplica temporariamente um conjunto de otimizações para o seu computador e/ou o Ruffle.
    O Ruffle requer modo de jogo somente quando um filme estiver sendo reproduzido.
gamemode-default = Padrão
gamemode-default-tooltip = O modo de jogo será ativado somente quando as opções de energia forem alto desempenho.
